...
function Page() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const redirectUrl = "https://stocktutor.chahataggrawal.in/vikramkashikar/thankyou";
                ...
                <div className="w-full">
                    ...
                    <section className="w-full px-4 py-6 bg-white">
                        <div className=" max-w-7xl mx-auto items-center flex flex-col">
                            ...
                            <img
                                src="/vikram.png" // Replace with your actual group photo
                                alt="Our Expert Tutors"
                                className="w-fit max-h-[500px] rounded-xl object-contain"
                            />
                        </div>
